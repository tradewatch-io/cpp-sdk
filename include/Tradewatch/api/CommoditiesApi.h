...
#ifndef IO_TRADEWATCH_CLIENT_API_CommoditiesApi_H_
#define IO_TRADEWATCH_CLIENT_API_CommoditiesApi_H_
...
public:
    ...
    explicit CommoditiesApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// <param name="type"> (optional, default to new CommodityType())</param>
    ...
    pplx::task<std::shared_ptr<CursorPage__T_Customized_SymbolsOutFull_>> getSymbols(
        ...
        boost::optional<std::shared_ptr<CommodityType>> type,
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<CommodityTypesList>> getTypes(
    ) const;
...
#endif /* IO_TRADEWATCH_CLIENT_API_CommoditiesApi_H_ */
