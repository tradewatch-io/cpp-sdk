...
#ifndef IO_TRADEWATCH_CLIENT_API_IndicesApi_H_
#define IO_TRADEWATCH_CLIENT_API_IndicesApi_H_
...
public:
    ...
    explicit IndicesApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* IO_TRADEWATCH_CLIENT_API_IndicesApi_H_ */
