...
#ifndef IO_TRADEWATCH_CLIENT_API_CryptoApi_H_
#define IO_TRADEWATCH_CLIENT_API_CryptoApi_H_
...
public:
    ...
    explicit CryptoApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* IO_TRADEWATCH_CLIENT_API_CryptoApi_H_ */
